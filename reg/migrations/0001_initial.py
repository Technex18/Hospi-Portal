    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.Event')),
            ],
        ),
        migrations.CreateModel(
            name='Exhibitions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questions', models.ManyToManyField(to='reg.questions')),
                ('quiz', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='quizTeam',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='ReaderStatus',
            fields=[
                ...
                ('notification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.Notification')),
            ],
        ),
        migrations.CreateModel(
            name='sheetpayment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bType', models.ManyToManyField(null=True, related_name='btype', to='reg.BusinessType')),
                ('pindusry', models.ManyToManyField(null=True, related_name='primary_industry', to='reg.PrimaryIndustry')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.StartUpFair')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.SmallIntegerField(default=0)),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.TeamList')),
            ],
        ),
        migrations.CreateModel(
            name='TechProfile',
            fields=[
                ...
                ('college', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.College')),
                ('fb', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.FbConnect')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('teamName', models.CharField(blank=True, max_length=50, null=True)),
                ('teamId', models.AutoField(primary_key=True, serialize=False)),
                ('members', models.ManyToManyField(related_name='members_for_workshop', to='reg.TechProfile')),
                ('teamLeader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teamLeaderForWorkshop', to='reg.TechProfile')),
                ('workshop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.Workshops')),
            ],
        ),
        migrations.AddField(
            model_name='workshopoptions',
            name='workshop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.Workshops'),
        ),
        migrations.AddField(
            model_name='team',
            name='members',
            field=models.ManyToManyField(null=True, related_name='members', to='reg.TechProfile'),
        ),
        migrations.AddField(
            model_name='team',
            name='teamLeader',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teamLeader', to='reg.TechProfile'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='sponsors',
            name='sponsorType',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.SponsorshipType'),
        ),
        migrations.AddField(
            model_name='sheetpayment',
            name='tech',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.TechProfile'),
        ),
        migrations.AddField(
            model_name='readerstatus',
            name='reader',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.TechProfile'),
        ),
        migrations.AddField(
            model_name='quizteam',
            name='members',
            field=models.ManyToManyField(null=True, related_name='quizMembers', to='reg.TechProfile'),
        ),
        migrations.AddField(
            model_name='quizteam',
            name='quiz',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.quiz'),
        ),
        migrations.AddField(
            model_name='quizresponses',
            name='quizTeam',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='reg.quizTeam2'),
        ),
        migrations.AddField(
            model_name='questions',
            name='quiz',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.quiz'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='metatags',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.ParentEvent'),
        ),
        migrations.AddField(
            model_name='event',
            name='parentEvent',
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reg.questions'),
        ),
        migrations.AddField(
            model_name='chutiyapa',
            name='quiz',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reg.quizResponses'),
        ),
    ]
